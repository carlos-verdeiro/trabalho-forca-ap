...
while opt != 2:
    ...
    while cat != 6:
        ...
        if cat == 1:
            ...
            ["Corneto","Parece uma trombeta, mas é mais curto e com som mais suave",2],
            ...
            ["Surdo","O que acontece quando perde a audição?",2],
            ["Caixa","Caixa economica federal",2],
            ...
            ["Reco-reco","Feito interiramente de madeira",2],
            ...
            ["Didgeridoo","Tem 2 metros",3],
            ["Harpa","Cupido",1],
            ["Ocarina","Jogo Zelda",2],
            ["Guzheng","Tocado com unhas postiças",3],
            ["Erhu","É usado pele de cobra na sua frabricação",3],
